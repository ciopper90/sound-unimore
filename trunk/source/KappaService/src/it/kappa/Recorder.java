...
public class Recorder extends Thread{
	...
	public Recorder(Context cont,SharedPreferences shared){
	...
	public void run(){
		...
		Log.d("kappaService", "Recorder started");
		...
		while(true){
			...
			i=0;
			//start elaborazione
			sample_value[k]=Features.extractFeature(audioBuffer,sampleRateInHz,context,textData,prefs);			
			//fine elaborazione
